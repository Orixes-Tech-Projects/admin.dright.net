...
<div class="card">
    <div class="card-header">
        <h4>List Of Customers Per Invoice Ledgers</h4>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table id="record" class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th data-priority="4">Total Invoices</th>
    ...
    <?php echo view('invoice/modal/per-invoice-payments'); ?>
    <script>
        $(document).ready(function () {
            $('#record').DataTable({
                ...
                "autoWidth": true,
                "ajax": {
                    "url": "<?= $path ?>invoice/fetch_per_invoice_ledgers",
                    "type": "POST"
                }
            });
        });
